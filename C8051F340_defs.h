...
/*
// TMR3CN 0x91
SBIT (TF3H,    TMR3CN, 7);         // Timer3 high byte overflow flag
SBIT (TF3L,    SFR_TMR3CN, 6);         // Timer3 low byte overflow flag
SBIT (TF3LEN,  SFR_TMR3CN, 5);         // Timer3 low byte interrupt enable
SBIT (T3CE,    SFR_TMR3CN, 4);         // Timer3 capture enable
SBIT (T3SPLIT, SFR_TMR3CN, 3);         // Timer3 split mode enable
SBIT (TR3,     SFR_TMR3CN, 2);         // Timer3 on/off control
SBIT (T3CSS,   SFR_TMR3CN, 1);         // Timer3 Capture Source select
SBIT (T3XCLK,  SFR_TMR3CN, 0);         // Timer3 external clock select
*/
// PSW 0xD0
